 ...
 * ---------------------------------
 * 
 * A otimização é um passo complicado e trabalhoso. Quando devemos otimizar
 * nossas queries?
 * 
 ...
 * 
 * Evitamos otimizar as queries até o momento em que mostramos numericamente que
 * elas estão ou atrapalharão nosso sistema. Enquanto elas não são um problema,
 * otimizar prematuramente pode ser complicar um código e deixá-lo difícil de se
 * manter. Encontrar o momento adequado - quando vale a pena complicar o código
 * com uma otimização - é um desafio.
 * 
 * 
 * 
 * 
