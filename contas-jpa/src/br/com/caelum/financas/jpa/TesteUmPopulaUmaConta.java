 ...
 * quando o objeto é retornado do banco mas o entityManager ja foi fechado para
 * resolver esse problema usa-se o em2.merge(conta);
 * 
 * 
 * 
 * Por último, há o estado Removed, que significa que não há mais representação
 * ou registro no banco, mas a entidade continua em memória.
 * 
 * 
 * 
 * 
