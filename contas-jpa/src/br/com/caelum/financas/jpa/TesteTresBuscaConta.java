...
public class TesteTresBuscaConta {
	...
	public static void main(String[] args) {
		...
		//o pulo do gato é não usar persiste nesse caso éusar merge
		em2.merge(conta);
 ...
 * 
 * 
 * Sobre o estado Managed podemos afirmar que: A característica do estado
 * Managed é a sincronização automática com o banco.
 *
 * 
 * 
