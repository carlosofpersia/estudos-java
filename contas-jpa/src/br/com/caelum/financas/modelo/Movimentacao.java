 ...
 * 
 * 
 * O interessante nisso tudo é que o select é processado pelo Hibernate assim
 * que ele é iniciado. Caso façamos alguma alteração no modelo sem replicá-la na
 * query, seremos avisados de antemão. Vamos fazer este teste, alterando valor
 * para valor2 no código abaixo, em Movimentacao:
 * 
 * 
 * Com o JPA, trabalhamos mais orientados à objetos, fazendo as buscas em cima
 * do nosso modelo. Pensando assim, poderia fazer sentido manter as consultas
 * junto às entidades. Fazemos isso com @NamedQuery.
 * 
 * 
 * Será que os @NamedQuery é o pai dos repositores?
 * 
 */